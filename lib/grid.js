(function (jQuery, methodName, factory) {
    ...
    var _initDOM = function () {
        var self = this,
            mainHeadersDiv, leftHeadersDiv, rightHeadersDiv, leftColumnsDiv, rightColumnsDiv,
        ...
        mainHeadersDiv = $('<div><table data-role="main-headers"><thead><tr><tr></thead></table></div>');
        mainHeadersDiv.css({
            'position': 'absolute',
            'z-index': 100,
            'left': leftPadding,
